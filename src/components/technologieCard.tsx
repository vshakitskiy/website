  ...
  return (
    <div className="flex flex-col rounded-lg border border-border lg:flex-row">
      <div className="flex h-28 w-full items-center justify-center rounded-t-lg bg-foreground lg:w-28 lg:rounded-l-lg lg:rounded-t-none">
        {data.name === "React" ? (
          <ReactIcon className="h-14 w-14 text-secondary" />
        ) : null}
        {data.name === "Typescript" ? (
          <TSIcon className="h-14 w-14 text-secondary" />
        ) : null}
        {data.name === "Next" ? (
          <NextIcon className="h-14 w-14 text-secondary" />
        ) : null}
        {data.name === "Tailwindcss" ? (
          <TailwindcssIcon className="h-14 w-14 text-secondary" />
        ) : null}
        {data.name === "Vite" ? (
          <ViteIcon className="h-14 w-14 text-secondary" />
        ) : null}
      </div>
